...
\subsection{Fases e substancias puras}
...
Entre as fases de fase única encontram se zonas em que existem duas fases em equilibrio: liquido-gas, sólido-liquido, e sólido-vapor.

Nas zonas de duas fases, a pressão e a temperatura não são independentes e o estado do sistema não poe ser definido apenas por temperatura e pressão. Para descrever o estado numa região de duas fases, é necessário indicar o volume específico, juntamente com a temperatura \textbf{ou} a pressão.
...
A zona líquido-vapor é chamada de \textbf{saturation dome} ou \textbf{cúpula de saturação}, e é limitada pelas linhas de líquido saturado e vapor saturado. No topo da cúpula, econtra se o \textbf{ponto crítico}. A cúpula é limitada inferiormente pela linha tripla.



\subsection{Projeções do diagrama $p-v-T$}
...
\begin{equation*}
    k = \frac{1}{v} \left( \frac{\partial v}{\partial T} \right)_p
\end{equation*}
