...
\subsubsection{Limitaçóes de eficiência}
Devido à 2ª Lei da Termodinâmica, que será estudada mais tarde, todos os coeficientes de eficiencia mencionados ($\eta$, $\beta$ e $\gamma$) têm um valor teórico máximo de 1, mas em aplicações reais vão ser sempre menores que 1.